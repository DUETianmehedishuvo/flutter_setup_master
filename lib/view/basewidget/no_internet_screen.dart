        ...
        child: Center(
          child: Column(
            ...
            children: [
              ...
              Text(isNoInternet ? getTranslated('OPPS', context) : getTranslated('sorry', context),
                      ...
                      child: TextButton(
                        ...
                        child: Container(
                          ...
                          child: Text(getTranslated('RETRY', context),
                              style: titilliumSemiBold.copyWith(color: Theme.of(context).accentColor, fontSize: Dimensions.FONT_SIZE_LARGE)),
                        ),
                      ),
                    )
                  : SizedBox.shrink(),
