  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: TextField(
        ...
        style: robotoRegular.copyWith(color: Colors.black87, fontSize: widget.isResponsive?20:Dimensions.FONT_SIZE_LARGE),
        ...
        decoration: InputDecoration(
          contentPadding: EdgeInsets.symmetric(vertical: widget.isResponsive?18:16, horizontal: widget.isResponsive?24:22),
          border: OutlineInputBorder(
            borderRadius: BorderRadius.circular(10.0),
            borderSide: BorderSide( width: widget.isShowBorder ? 1 : 0, color: widget.isShowBorder ? Colors.green : Colors.transparent),
          ),
          isDense: true,
          hintText: widget.hintText,
          fillColor: widget.fillColor != null ? widget.fillColor : Colors.white,
          hintStyle: robotoRegular.copyWith(fontSize: widget.isResponsive?20:Dimensions.FONT_SIZE_LARGE, color: Colors.grey),
          filled: true,
